...
{ //Multi-threaded link to UObjects, do not create,modify,destroy UObjects / AActors via this link!
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~
    //~~~~~~~~~~~~~~~~~~~~~~~~~~
    // OUTPUT RESULTS OF TASK THREADS TArray PrimeNumbers;
    ...
    void FindPrimes(const uint32 TotalToFind)
    {
        ...
        {
            VictoryMultithreadTest_CompletionEvents.Add(TGraphTask::CreateTask(NULL, ENamedThreads::GameThread).ConstructAndDispatchWhenReady());
...
void AVictoryGamePlayerController::VictoryCheckAllThreadsDone()
{
    ...
    {
        //Clear Timer
        GetWorldTimerManager().ClearTimer(this, &AVictoryGamePlayerController::VictoryCheckAllThreadsDone);
...
void AVictoryGamePlayerController::StartThreadTest()
{
    ...
    GetWorldTimerManager().SetTimer(this, &AVictoryGamePlayerController::VictoryCheckAllThreadsDone, 1, true);
}